      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-5">
            ...
            {user ? (
              <>
                {/* Show Dashboard Icon Only for Students */}
                {user.role === 'student' && (
                  <button 
                  ...
                  >
                    <User className="w-4 h-4 text-[#6D28D9] group-hover:text-[#7C3AED]" />
                    <span>Dashboard</span>
                  </button>
                )}
                
                {/* Profile Menu for All Logged-in Users */}
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-[#DDD6FE]">
            <div className="flex flex-col space-y-2">
              ...
              {user ? (
                <div className="p-3">
                  {/* Show Dashboard Option for Students */}
                  {user.role === 'student' && (
                    <button 
                      onClick={handleDashboardClick}
                      className="w-full text-left p-3 text-[#4C1D95] hover:bg-[#F5F3FF] rounded-lg font-medium mb-2"
                    >
                      <User className="w-5 h-5 text-[#6D28D9] inline mr-2" />
                      Go to Dashboard
                    </button>
                  )}
                ...
                <div className="flex flex-col space-y-2 p-3">
                  <button 
                    ...
                    className="w-full text-left p-3 text-[#4C1D95] hover:bg-[#F5F3FF] rounded-lg font-medium"
                  >
                    Login
                  </button>
                  <button 
                    ...
                    className="w-full bg-[#7C3AED] hover:bg-[#6D28D9] text-white p-3 rounded-lg font-medium transition-colors"
                  >
                    Register
                  </button>
                </div>
